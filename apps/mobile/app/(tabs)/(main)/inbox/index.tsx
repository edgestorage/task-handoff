...
export default function InboxRoute() {
  const { actions, refresh, state } = useActiveAiSessions();
  ...
  return <AiSessionInbox actions={actions} directory={directory} initialScope={scope} state={state} onRefresh={refresh} onOpen={({ instanceId: targetInstanceId, sessionId }) => router.push({ pathname: '/sessions/[instanceId]/[sessionId]', params: { instanceId: targetInstanceId, sessionId } })} />;
}
