...
const knownApiErrors: Record<string, ErrorDescriptor> = {
  ...
  AUTH_PASSWORD_CHANGE_REQUIRED: { key: "errors.AUTH_PASSWORD_CHANGE_REQUIRED" },
  ...
  CONTROL_PLANE_LOCAL_IDENTITY_IMMUTABLE: { key: "errors.CONTROL_PLANE_LOCAL_IDENTITY_IMMUTABLE" },
  CONTROL_PLANE_IDENTITY_PROVIDER_NAMESPACE_IMMUTABLE: { key: "errors.CONTROL_PLANE_IDENTITY_PROVIDER_NAMESPACE_IMMUTABLE" },
  ...
  MODEL_API_KEY_REQUIRED: { key: "errors.MODEL_API_KEY_REQUIRED" },
  MODEL_ENDPOINT_INVALID: { key: "errors.MODEL_ENDPOINT_INVALID" },
  MODEL_ENDPOINT_TIMEOUT: { key: "errors.MODEL_ENDPOINT_TIMEOUT" },
  MODEL_ENDPOINT_UNREACHABLE: { key: "errors.MODEL_ENDPOINT_UNREACHABLE" },
  MODEL_DISCOVERY_FAILED: { key: "errors.MODEL_DISCOVERY_FAILED" },
  MODEL_DISCOVERY_UNSUPPORTED: { key: "errors.MODEL_DISCOVERY_UNSUPPORTED" },
  ...
  NODE_FOLDER_PATH_NOT_FOUND: { key: "errors.NODE_FOLDER_PATH_NOT_FOUND" },
  NODE_FOLDER_PATH_NOT_DIRECTORY: { key: "errors.NODE_FOLDER_PATH_NOT_DIRECTORY" },
  NODE_FOLDER_PATH_UNREADABLE: { key: "errors.NODE_FOLDER_PATH_UNREADABLE" },
  ...
  NODE_MODEL_ENDPOINT_PROBE_UNSUPPORTED: { key: "errors.NODE_MODEL_ENDPOINT_PROBE_UNSUPPORTED" },
  ...
  AI_SESSION_FILE_ATTACHMENT_LIMIT_UNSUPPORTED: { key: "errors.AI_SESSION_FILE_ATTACHMENT_LIMIT_UNSUPPORTED" },
  AI_SESSION_RUNTIME_PATH_UNSUPPORTED: { key: "errors.AI_SESSION_RUNTIME_PATH_UNSUPPORTED" },
  AI_SESSION_REASONING_EFFORT_UNSUPPORTED: { key: "errors.AI_SESSION_REASONING_EFFORT_UNSUPPORTED" },
  AI_SESSION_REASONING_EFFORT_CONFLICT: { key: "errors.AI_SESSION_REASONING_EFFORT_CONFLICT" },
  AI_SESSION_REASONING_EFFORT_UNKNOWN: { key: "errors.AI_SESSION_REASONING_EFFORT_UNKNOWN" },
  AI_SESSION_REASONING_EFFORT_INVALID_RESPONSE: { key: "errors.AI_SESSION_REASONING_EFFORT_INVALID_RESPONSE" },
  ...
  REPOSITORY_CREDENTIAL_MISSING: { key: "errors.REPOSITORY_CREDENTIAL_MISSING" },
  REPOSITORY_CREDENTIAL_AMBIGUOUS: { key: "errors.REPOSITORY_CREDENTIAL_AMBIGUOUS" },
  REPOSITORY_REMOTE_UNSUPPORTED: { key: "errors.REPOSITORY_REMOTE_UNSUPPORTED" },
  REPOSITORY_HOST_KEY_REQUIRED: { key: "errors.REPOSITORY_HOST_KEY_REQUIRED" },
  REPOSITORY_AUTHENTICATION_REJECTED: { key: "errors.REPOSITORY_AUTHENTICATION_REJECTED" },
