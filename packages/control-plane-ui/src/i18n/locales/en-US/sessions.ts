export const sessions = {
  ...
  actions: {
    ...
    addToStory: "Add to Story", addToConversation: "Add to conversation", saveAsPreset: "Save as preset action", loadingStories: "Loading stories…", storiesLoadFailed: "Could not load stories.", noStories: "No Story yet", storyAssigned: "Added to Story", storyAssignFailed: "Could not add AI session to Story",
  ...
  panel: {
    ...
    noMatching: "No matching sessions", noConversations: "No conversations yet", tryFilter: "Try another status filter.", startHint: "Use the + button above to start a conversation.", noAgentsTitle: "No AI agent is installed", noAgentsDescription: "Install an AI agent in this instance before starting a session.", openAppManagement: "Open App management",
    ...
    chooseWorktree: "Choose worktree", searchWorktrees: "Search worktrees", noWorktrees: "No matching worktrees", newWorktree: "New worktree", newWorktreeDescription: "Create an isolated worktree from an existing branch or a new branch, then start this AI session there.", newWorktreeMode: "Worktree branch mode", existingBranch: "Existing branch", newBranch: "New branch", branch: "Branch", noBranches: "No matching branches", newWorktreeDetachedDescription: "This ref is already checked out. The new worktree will use its current commit in detached HEAD mode.", newWorktreeBranch: "New branch", newWorktreeStartRef: "Start ref", useNewWorktree: "Use new worktree", currentWorktree: "Current", mainWorktree: "Main", managedWorktree: "Managed", externalWorktree: "External", dirtyWorktree: "Dirty", worktreeInUse: "In use", unknownBranch: "Unknown branch", unbornBranch: "Unborn branch", detachedWorktree: "Detached at {commit}",
    promptPlaceholder: "Do anything", chooseProject: "Choose project", projectUnavailable: "This project is no longer registered on the node.", startedWorktree: "AI session started in the selected worktree.", backLatest: "Back to latest", backLatestTurn: "Latest",
  ...
  composer: {
    ...
    noMatches: "No matches", commands: "Commands", loading: "Loading...", openCommands: "Open command menu", permissionMode: "Permission mode: {mode}", choosePermission: "Choose permission mode", modelSelectionTitle: "Model: {model}", modelSelectionUnavailable: "Model switching is unavailable for this session", noModelConfigured: "No model", openModelSettings: "Open settings", modelGroupSummary: "{model} and {count} models", provider: "Provider", model: "Model", reasoningEffort: "Reasoning effort", selectionNotSet: "Not set",
  ...
  timeline: {
    ...
    output: "Output",
    copyDiff: "Copy diff",
    fileDiff: "File diff for {path}",
    noFileDiff: "No textual diff is available",
    commandShell: "Shell",
