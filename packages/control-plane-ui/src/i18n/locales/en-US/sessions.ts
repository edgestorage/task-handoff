export const sessions = {
  ...
  composer: {
    ...
    noMatches: "No matches", commands: "Commands", loading: "Loading...", openCommands: "Open command menu", permissionMode: "Permission mode: {mode}", choosePermission: "Choose permission mode", modelSelectionTitle: "Model: {model}", modelSelectionUnavailable: "Model switching is unavailable for this session", modelGroupSummary: "{model} and {count} models", provider: "Provider", model: "Model", reasoningEffort: "Reasoning effort", selectionNotSet: "Not set",
