export const sessions = {
  ...
  actions: {
    ...
    moreFor: "More actions for {agent}", more: "More actions", fork: "Create branch", forkCurrent: "Use current workspace", forkWorktree: "Create independent worktree", forkThroughTurn: "Create branch through this turn", forkBusyTitle: "Create branch while this turn is running?", forkBusyDescription: "Codex will create the branch from its interrupted snapshot. The source turn will continue without interruption.", forkConfirm: "Create branch", forking: "Creating branch", closingApp: "Closing app session", closeApp: "Close app session", closingSession: "Closing AI session", closeSession: "Close AI session", unread: "Unread AI session", openedFromTerminal: "Opened from a terminal app session",
  ...
  panel: {
    ...
    stopFailed: "Failed to stop AI session.", forkFailed: "Failed to create an AI session branch.", forkProjectionPending: "The branch was created, but its session state is not confirmed yet. Retry shortly.", approvalFailed: "Failed to resolve approval.", closeAppFailed: "Failed to close app session.", closeSessionFailed: "Failed to close AI session.", openAppFailed: "Failed to open an app for the AI session.",
  ...
  tabs: {
    ...
    expand: "Expand session preview", restoreShort: "Restore preview", expandShort: "Expand preview", resizePanes: "Resize session panes", instanceStatus: "Instance status", showStatusBar: "Show bottom status bar",
