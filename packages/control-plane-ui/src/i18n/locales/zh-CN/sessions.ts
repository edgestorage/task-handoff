...
export const sessions = {
  ...
  composer: {
    ...
    fullAccessDescription: "无需审批即可无限制访问互联网和文件。", localPath: "本地路径", removeAttachment: "移除附件", previewImage: "预览 {name}", copyImage: "复制图片", imageCopied: "图片已复制", copyImageFailed: "无法复制图片。", uploadProgress: "正在上传：{progress}%", blankPastedText: "空白文本", textLength: "{count} 个字符", followUp: "请求后续修改",
