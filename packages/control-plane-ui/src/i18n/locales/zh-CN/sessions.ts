...
export const sessions = {
  ...
  composer: {
    ...
    noMatches: "没有匹配项", commands: "命令", loading: "正在加载...", openCommands: "打开命令菜单", permissionMode: "权限模式：{mode}", choosePermission: "选择权限模式", modelSelectionTitle: "模型：{model}", modelSelectionUnavailable: "当前会话模型不可切换", modelGroupSummary: "{model} 等 {count} 个模型", provider: "Provider", model: "模型", reasoningEffort: "思考程度", selectionNotSet: "未设置",
