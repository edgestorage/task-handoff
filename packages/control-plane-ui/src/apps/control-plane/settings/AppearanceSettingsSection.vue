        ...
        <div class="group-surface">
          <div class="setting-row">
            ...
            <div v-else class="maintenance-control">
              ...
              <p v-if="serverUpdateCheck" class="setting-note">{{ t("settings.nodeDetail.serverUpdateImpact", { restarting: serverUpdateCheck.impact.restartInstanceCount, active: serverUpdateCheck.impact.activeInstanceCount, stopped: serverUpdateCheck.impact.stoppedInstanceCount }) }}</p>
              ...
              <p v-if="serverUpdateJob?.error" class="setting-note settings-error">{{ serverUpdateJob.error.message }}</p>
            </div>
          </div>
