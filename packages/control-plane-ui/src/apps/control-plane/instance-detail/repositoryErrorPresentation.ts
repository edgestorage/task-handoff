...
const recoveryCodes = new Set([
  ...
  "REPOSITORY_CREDENTIAL_MISSING", "REPOSITORY_CREDENTIAL_AMBIGUOUS", "REPOSITORY_REMOTE_UNSUPPORTED",
  "REPOSITORY_HOST_KEY_REQUIRED", "REPOSITORY_AUTHENTICATION_REJECTED",
